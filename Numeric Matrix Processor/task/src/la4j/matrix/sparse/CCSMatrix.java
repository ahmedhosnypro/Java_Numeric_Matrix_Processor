...
import la4j.iterator.ColumnMajorMatrixIterator;
import la4j.iterator.VectorIterator;
import la4j.Matrices;
import la4j.Matrix;
import la4j.matrix.ColumnMajorSparseMatrix;
import la4j.matrix.MatrixFactory;
import la4j.matrix.functor.MatrixFunction;
import la4j.matrix.functor.MatrixProcedure;
import la4j.Vector;
import la4j.vector.functor.VectorProcedure;
import la4j.vector.sparse.CompressedVector;
